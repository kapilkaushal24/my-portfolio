        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-8 sm:pb-12 lg:pb-16 text-4xl sm:text-5xl md:text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl"
            >
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="my-2 max-w-xl py-4 sm:py-6 font-light tracking-tight text-center lg:text-left px-2 sm:px-0"
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 w-full sm:w-auto px-2 sm:px-0"
            >
              <a
                href="/Kapil-Kaushal-Resume.docx"
                download="Kapil-Kaushal-Resume.docx"
                className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-sm sm:text-base font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 border-2 border-purple-600 text-purple-400 hover:bg-purple-600 hover:text-white text-sm sm:text-base font-semibold rounded-lg transition-all duration-300"
              >
