  ...
  return (
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        >
          <img className="w-16" src={dotnet} alt=".NET Core" />
        </motion.div>
        <motion.div
          variants={iconVar(3)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <img className="w-16" src={csharp} alt="C#" />
        </motion.div>
        <motion.div
          variants={iconVar(2)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaCloud className="text-7xl text-blue-500" />
        </motion.div>
        <motion.div
          variants={iconVar(2)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <img className="w-16" src={sql} alt="SQL Server" />
        </motion.div>
        <motion.div
        ...
        <motion.div className="w-full mt-8">
          <motion.h3
            ...
            className="text-center text-2xl text-purple-400 mb-6"
          >
          ...
          >
            <motion.div
              ...
              initial="initial"
              animate="animate"
              className="rounded-2xl border-4 border-purple-600 p-4 bg-gradient-to-r from-purple-900/20 to-pink-900/20"
            >
              <div className="text-center">
                <div className="text-4xl mb-2">🤖</div>
                <span className="text-sm text-purple-300">LangChain</span>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="text-center">
                <div className="text-4xl mb-2">🤗</div>
                <span className="text-sm text-purple-300">HuggingFace</span>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="text-center">
                <div className="text-4xl mb-2">🧠</div>
                <span className="text-sm text-purple-300">OpenAI</span>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="text-center">
                <div className="text-4xl mb-2">📊</div>
                <span className="text-sm text-purple-300">Vector DBs</span>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="text-center">
                <div className="text-4xl mb-2">⚡</div>
                <span className="text-sm text-purple-300">RAG Systems</span>
              </div>
            </motion.div>
            <motion.div
              variants={iconVar(3.5)}
            ...
            >
              <div className="text-center">
                <div className="text-4xl mb-2">🔗</div>
                <span className="text-sm text-purple-300">AI Agents</span>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
